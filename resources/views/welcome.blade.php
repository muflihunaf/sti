      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            ...
            <p>SI PELAS adalah sistem informasi yang berfungsi untuk menampung laporan keluh kesah dari masyarakat terkait fasilitas, kehilangan barang dan aspirasi kepada instansi yang berwenang. </p>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon"><i class="bx bx-comment-check"></i></div>
              <h4 class="title"><a href="">Praktis</a></h4>
              <p class="description">Dengan adanya SI PELAS ini, masyarakat tidak perlu harus pergi ke instansi daerah sekitar untuk melaporkannya secara langsung. </p>
            </div>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
              <div class="icon"><i class="bx bx-mobile-alt"></i></div>
              <h4 class="title"><a href="">Simple</a></h4>
              <p class="description">Lakukan pengaduan melalui website ini, lalu sertakan bukti foto beserta deskripsinya.</p>
            </div>

            <div class="icon-box" data-aos="zoom-in" data-aos-delay="300">
              <div class="icon"><i class="bx bx-search-alt"></i></div>
              <h4 class="title"><a href="">Cepat</a></h4>
              <p class="description">Pemerintah daerah atau pihak yang berwenang akan segera melakukan tindakan untuk mengatasinya.</p>
            </div>
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="63" data-purecounter-duration="3" class="purecounter"></span>
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="nomor" class="form-control" id="nomor" placeholder="Nomor Pelapor" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Tanggal Kejadian" required>
                </div>
              </div>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Tempat Kejadian" required>
              </div>
              <div class="form-group mt-3">
                <textarea class="form-control" name="message" rows="5" placeholder="Deskripsi Kejadian" required></textarea>
              </div>
               <div class="form-group mt-3">
